...
Informatics student at Telkom University (graduating 2027) building production web apps and applied machine-learning systems. Currently a Web Developer Intern at PT PLN (Persero).

[Portfolio](https://sihazel.com) · [LinkedIn](https://linkedin.com/in/jianhazel)

## Highlights

- Co-authored a paper in **JADIMI (2026)**: hybrid Grey Wolf Optimizer–Tabu Search for multi-day tourist itinerary recommendation in Jakarta.
- **2 registered software copyrights** (DJKI): Jakarta Routes and MindCare Mobile.
- **Top 10** at the DQLab Python Hackathon 2026 (Retail Crisis & Recovery).
...
- **Web & mobile:** Laravel, Vue 3, React, FastAPI, Tailwind CSS, Flutter
- **ML / Data:** PyTorch, scikit-learn, XGBoost, Pandas, Apache Spark, Hugging Face
- **Data stores & tools:** MySQL, MongoDB, Chroma, Docker, Jenkins, Git

## Contact

Open to Software Engineering, Data, and AI internships.
Reach me on [LinkedIn](https://linkedin.com/in/jianhazel) or via [sihazel.com](https://sihazel.com).
